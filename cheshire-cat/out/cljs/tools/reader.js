...
var G__6258 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__6258;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__6259 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__6259,ch);
...
if(("\\" === ch__$1)){
var ch_6260__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_6260__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_6260__$2);
} else {
}

var G__6261 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__6261;
continue;
}
}
...
var vec__6269 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__6269,(0),null);
var start_column = cljs.core.nth.call(null,vec__6269,(1),null);
...
var G__6272 = cljs.core.conj_BANG_.call(null,a,form);
a = G__6272;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__6273 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__6274 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__6274);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__6273);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__6275 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__6275,(0),null);
var start_column = cljs.core.nth.call(null,vec__6275,(1),null);
...
var vec__6278 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__6278,(0),null);
var end_column = cljs.core.nth.call(null,vec__6278,(1),null);
...
var vec__6281 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__6281,(0),null);
var start_column = cljs.core.nth.call(null,vec__6281,(1),null);
...
var vec__6284 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__6284,(0),null);
var end_column = cljs.core.nth.call(null,vec__6284,(1),null);
...
var vec__6287 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__6287,(0),null);
var start_column = cljs.core.nth.call(null,vec__6287,(1),null);
...
var vec__6290 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__6290,(0),null);
var end_column = cljs.core.nth.call(null,vec__6290,(1),null);
...
var sb = (function (){var G__6293 = (new goog.string.StringBuffer());
G__6293.append(initch);
...
var G__6295 = (function (){var G__6294 = sb;
G__6294.append(ch);

return G__6294;
})();
var G__6296 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__6295;
ch = G__6296;
continue;
}
...
switch (G__6299) {
case "\\":
var G__6303 = (function (){var G__6300 = sb;
G__6300.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__6300;
})();
var G__6304 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__6303;
ch = G__6304;
continue;
...
break;
default:
var G__6305 = (function (){var G__6301 = sb;
G__6301.append(ch);

return G__6301;
})();
var G__6306 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__6305;
ch = G__6306;
continue;
...
var vec__6307 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__6307,(0),null);
var end_column = cljs.core.nth.call(null,vec__6307,(1),null);
...
var vec__6310 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__6310,(0),null);
var column = cljs.core.nth.call(null,vec__6310,(1),null);
...
var vec__6315 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__6315,(0),null);
var column = cljs.core.nth.call(null,vec__6315,(1),null);
...
var vec__6320 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__6320,(0),null);
var column = cljs.core.nth.call(null,vec__6320,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__6325 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__6325,(0),null);
var start_column = cljs.core.nth.call(null,vec__6325,(1),null);
...
var vec__6328 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__6328,(0),null);
var end_column = cljs.core.nth.call(null,vec__6328,(1),null);
...
var G__6331 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__6331,true,null,opts,pending_forms);
...
var G__6332 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__6332)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__6332)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__6332)){
...
var _STAR_suppress_read_STAR__orig_val__6333 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__6334 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__6334);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__6333);
}});
...
var G__6335 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__6335,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__6335,rdr,first_line);
...
var G__6339 = matched;
var G__6340 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__6339;
finished = G__6340;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__6341 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__6342 = (function (){var or__4126__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__6342);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__6341);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__6343 = cljs.tools.reader.arg_env;
var arg_env_temp_val__6344 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__6344);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__6345 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__6345,"(");
...
var G__6346 = (i + (1));
var G__6347 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4126__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__6343);
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__6348 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__6348);
...
var G__6349 = cljs.core.next.call(null,s__$1);
var G__6350 = ret;
s__$1 = G__6349;
r = G__6350;
continue;
...
var G__6351 = cljs.core.next.call(null,s);
var G__6352 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__6351;
key_vals = G__6352;
continue;
} else {
...
var gensym_env_orig_val__6357 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__6358 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__6358);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__6357);
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__6359 = token;
var G__6359__$1 = (((G__6359 == null))?null:cljs.core.subs.call(null,G__6359,(1)));
var G__6359__$2 = (((G__6359__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__6359__$1));
var G__6359__$3 = (((G__6359__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__6359__$2));
var G__6359__$4 = (((G__6359__$3 == null))?null:cljs.core.symbol.call(null,G__6359__$3));
if((G__6359__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__6359__$4);
}
})():(function (){var G__6360 = token;
var G__6360__$1 = (((G__6360 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__6360));
if((G__6360__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__6360__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
}catch (e6367){if((e6367 instanceof Error)){
var e = e6367;
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__6371,reader){
...
var opts = map__6372__$1;
var eof = cljs.core.get.call(null,map__6372__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
