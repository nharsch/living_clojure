...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_4162 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_4162.call(null,port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_4163 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_4163.call(null,port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_4164 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_4164.call(null,chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_4165 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_4165.call(null,chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_4166 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_4166.call(null,h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_4167 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_4167.call(null,h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_4168 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_4168.call(null,b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_4169 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_4169.call(null,b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_4170 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_4170.call(null,b,itm);
}
});
